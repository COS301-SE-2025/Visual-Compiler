...
<div class="phase-tutorial">
  <div class="tutorial-content">
    ...
    <p class="description">
      Parsing is the process of analyzing a sequence of tokens (words/symbols) to determine its structure according to a set of grammar rules. After the lexer (tokenizer) breaks down source code into tokens, the parser takes over to understand the structure and meaning of those tokens.
    </p>
        ...
        {:else if current_step === 5}
          <div class="tutorial-step">
            ...
            <ol class="step-breakdown">
              <li><b>Root (<span class="cfg-nt">STATEMENT</span>)</b>: Must expand to <span class="cfg-nt">DECLARATION</span> <span class="cfg-t">SEPARATOR</span>.</li>
              <li><b>DECLARATION</b>: Expands to <span class="cfg-nt">TYPE IDENTIFIER ASSIGNMENT EXPRESSION</span>:
                <ul>
              ...
              <li><b>EXPRESSION</b>: Expands to <span class="cfg-t">5 + 3</span>:
                <ul>
              ...
              <li><b>Termination</b>: <span class="cfg-t">SEPARATOR</span> → <span class="cfg-t">";"</span> ends the statement.</li>
            </ol>
          </div>
        {/if}
      </div>
