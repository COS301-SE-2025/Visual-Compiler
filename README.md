...
<table style="border-width: 1px; width: 100%;">
    <tr>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
            <img src="assets/sashen.jpg" width="600" height="auto" style="object-fit: cover;">
        </td>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
    ...
    <tr>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
            <img src="assets/tia.jpg" width="600" height="auto" style="object-fit: cover;">
        </td>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
    ...
    <tr>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
            <img src="assets/keanu.jpg" width="600" height="auto" style="object-fit: cover;">
        </td>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
    ...
    <tr>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
            <img src="assets/devan.jpg" width="600" height="auto" style="object-fit: cover;">
        </td>
        <td style="vertical-align: middle; width: auto; border: 0; padding: 10px;">
